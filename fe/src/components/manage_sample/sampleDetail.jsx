...
import {
    api_get_sample_face_detect_by_id,
    api_update_sample_face_detect,
    api_get_labels,
    api_update_sample_eye_state,
    api_get_sample_eye_state_by_id,
} from '../../config/Api';
                ...
                <div className="sample-inf-container">
                    <div className="sample-inf">
                        ...
                        <div className="sample-inf-child">
                            ...
                            >
                                <option value="true" className="option-item" selected>
                                    True
                                </option>
