        ...
        <div className="main-sample-container">
            ...
            <div className="add-sample-container custom-add-sample-ctn">
                <div className="post-image">
                    ...
                    />
                    <img
                        src={sample?.urlImage !== undefined ? sample?.urlImage : upload}
                        alt="upload"
                    ...
                    <div className="sample-inf">
                        ...
                        <div className="sample-inf-child">
                            ...
                            <input
                                ...
                                placeholder="size"
                                value={sample.size}
                                onChange={(e) => setSample({ ...sample, size: e.target.value })}
                            ></input>
                        </div>
                        <div className="sample-inf-child">
                            ...
                            <input
                                ...
                                onChange={(e) => setSample({ ...sample, extension: e.target.value })}
                            ></input>
                        </div>
                        {typeSample === '2' ? (
                            <div className="sample-inf-child sample-child-edit">
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setSample({ ...sample, label: { ...sample.label, id: e.target.value } })
                                    }
                                >
                                    ...
                                    {labels.map((label) => (
                                        <option value={label.id} className="option-item">
                                            {label.name}
                                        </option>
                                    ))}
                                </select>
                        ...
                        <div className="sample-inf-child">
                            ...
                            >
                                ...
                                <option value="true" className="option-item">
                                    True
                                </option>
                                <option value="false" className="option-item">
                                    False
                                </option>
                            </select>
                        </div>
            ...
            {typeSample === '1' ? (
                <div className="add-sample-container">
                    <div className="post-image">
                        <input type="file" accept=".txt" className="input-upload" onChange={handleFileChange} />
                        <img
                            src={uploadTxt}
                            alt="upload"
                            className="img-upload"
                            style={{ display: sample?.boudingboxes === undefined ? 'block' : 'none' }}
                        ></img>
                    </div>
                    ...
                    <div className="sample-inf-container">
                        <div className="sample-inf">
                            ...
                            <button className="btnEdit" onClick={hanldAddLine}>
                                Add new line
                            </button>
                        </div>
                    </div>
            ...
            <div className="add-sample-controller">
                <button className="btnEdit" onClick={handleClickRefresh}>
                    Refresh
                </button>
                <button className="btnEdit" onClick={hanldeSubmit}>
                    Save
                </button>
            </div>
        </div>
