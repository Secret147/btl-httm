...
import {
    api_delete_sample_eye_state,
    api_delete_sample_face_detect,
    api_get_sample_eye_states,
    api_get_sample_face_detects,
} from '../../config/Api';
function MainSample() {
    ...
    const handleSearch = (e) => {
        ...
        const sampleSearch = samples.filter((sample) => sample.name.toLowerCase().includes(key.toLowerCase()));
        ...
        <div className="sample-manage-container">
            <div className="inf-sample">
                ...
                <div class="select-type-sample-container">
                    <select className="select-sample" value={typeSample} onChange={(e) => handleSelectTypeSample(e)}>
                        <option disabled selected hidden className="option-item">
                            Type Sample
                        </option>
            ...
            <div className="sample-controller">
                <div className="btn-controller">
                    <button className="btn-add btnEdit" onClick={handleClickAdd}>
                        Add
                    </button>
                    <button className="btnEdit btn_del" onClick={handleClickDel}>
                        Delete
                    </button>
                    <button className="btn-add btnEdit" onClick={hanldClickSelect}>
                        Select
                    </button>
                </div>
                ...
                <div className="search-sample">
                    ...
                    <button type="submit" className="btnEdit btn-search-edit">
                        Tìm
                    </button>
                </div>
            </div>
