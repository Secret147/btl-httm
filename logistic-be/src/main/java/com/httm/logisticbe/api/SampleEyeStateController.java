...
public class SampleEyeStateController {
	...
	public sampleEntity getSampleEyeStateByID(@PathVariable String id) {
		try {
	...
	public ResponseEntity<?> addNewSampleEyeState(@RequestBody sampleEntity sample) {
	...
	public ResponseEntity<?> updateSampleEyeState(@RequestBody sampleEntity sample) {
		Map<String, Boolean> status = new HashMap<>();
